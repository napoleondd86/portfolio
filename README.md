...
THEN the UI scrolls to the corresponding section     //DONE --TECHNICALLY --need to improve about styling
...
THEN I am taken to that deployed application    //ONLY CONNECTS WITH H3 tags
